/*
 * @Author: yeyuhang
 * @Date: 2020-09-28 11:58:15
 * @LastEditTime: 2020-09-28 15:38:01
...
// 此时就只能用类型断言，通过判断是否存在 code 属性，
// 来判断传入的参数是不是 ApiError 了：
export const DEMO_8 = () => {
    interface ApiError extends Error {
        code: number;
    }
...
// 它们可能是由于第三方库未能定义好自己的类型，也有可能是历史遗留的或其他人编写的烂代码，
...
export const DEMO_12 = () => {
    function getCacheData(key: string): any {
        return (window as any).cache[key];
    }
}
// 那么我们在使用它时，最好能够将调用了它之后的返回值断言成一个精确的类型，这样就方便了后续的操作：
export const DEMO_13 = () => {
    function getCacheData(key: string): any {
        return (window as any).cache[key];
    }
...
export const DEMO_25 = () => {
    const tom = getCacheData('tom') as Cat;
}
// 等价于
export const DEMO_26 = () => {
    const tom: Cat = getCacheData('tom');
}
